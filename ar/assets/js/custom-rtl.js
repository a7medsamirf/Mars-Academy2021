		...
		Basic: {
			...
			ylpreloader: function (){
				jQuery(window).on('load', function(){
					jQuery('#Mars-preloader').fadeOut('slow',function(){jQuery(this).remove();});
				});
			...
			BackgroundImage: function (){
				...
				jQuery('#Mars-main-slider-3').owlCarousel({
					items: 1,
					loop: true,
					nav: true,
					dots: false,
				...
				$(window).on('load',function(){
					$('.Mars-top-category-slider').owlCarousel({
						margin:30,
			...
			ylStickymenu: function (){
				jQuery(window).on('scroll', function() {
					if (jQuery(window).scrollTop() > 100) {
						jQuery('.Mars-header-main').addClass('Mars-sticky-menu')
					} else {
						jQuery('.Mars-header-main').removeClass('Mars-sticky-menu')
					}
				})
			},
			ylMobileMenu: function (){
				$('.Mars-open_mobile_menu').on("click", function() {
					$('.Mars-mobile_menu_wrap').toggleClass("mobile_menu_on");
				});
				$('.Mars-open_mobile_menu').on('click', function () {
					$('body').toggleClass('mobile_menu_overlay_on');
				});
				if($('.Mars-mobile_menu li.dropdown ul').length){
					$('.Mars-mobile_menu li.dropdown').append('<div class="dropdown-btn"><span class="fa fa-angle-down"></span></div>');
					$('.Mars-mobile_menu li.dropdown .dropdown-btn').on('click', function() {
						$(this).prev('ul').slideToggle(500);
					});
				}
			},
			ylSliderMain: function (){
				jQuery('#Mars-main-slider').owlCarousel({
					items: 1,
					loop: true,
					nav: false,
					rtl: true,
				...
				jQuery('#Mars-main-slider-2').owlCarousel({
					items: 1,
					loop: true,
					nav: true,
					rtl: true,
			...
			YlDepartment: function (){
				$(window).on('load',function(){
					$('#Mars-department-slider-id').owlCarousel({
						margin:30,
						responsiveClass:true,
						nav: true,
						dots: false,
			...
			YlTestimonial1: function (){
				$(window).on('load',function(){
					$('#Mars-testimonial-slide').owlCarousel({
						margin:0,
						items: 1,
						nav: false,
						dots: true,
			...
			Ylblog: function (){
				$(window).on('load',function(){
					$('#Mars-blog-slider-id').owlCarousel({
						margin:30,
						responsiveClass:true,
						nav: true,
						dots: false,
			...
			YLcategory: function (){
				$(window).on('load',function(){
					$('#Mars-category-slide').owlCarousel({
						margin:30,
						responsiveClass:true,
						nav: false,
						dots: true,
			...
			YlTestimonial12: function (){
				$(window).on('load',function(){
					$('#Mars-testimonial-slide-2').owlCarousel({
						margin:30,
						responsiveClass:true,
						nav: false,
						dots: true,
